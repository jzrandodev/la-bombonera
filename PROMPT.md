...
Structure it as seven chapters — arrival, the streets, the threshold, the room under the stand, the pitch, the stands, and a closing manifesto. Set oversized, left-aligned, condensed display headings against small technical labels in mono, thick rules, and a lot of empty space. A second, larger stencil word sits behind each chapter as texture.
